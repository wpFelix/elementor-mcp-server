...
use function ElementorMCP\Abilities\WordPress\builder_remedy;
use function ElementorMCP\Abilities\WordPress\register_core_ability;
use function ElementorMCP\Abilities\WordPress\wordpress_builder_meta_error;
use function ElementorMCP\Abilities\WordPress\wordpress_create_capability_error;
use function ElementorMCP\Abilities\WordPress\wordpress_post_type_is_agent_facing;
use function ElementorMCP\Abilities\WordPress\wordpress_postmeta_builder_content_gate;
use function ElementorMCP\Abilities\WordPress\wordpress_postmeta_builder_content_warnings;
use function ElementorMCP\Abilities\WordPress\wordpress_postmeta_builder_owner;
use function ElementorMCP\Abilities\WordPress\wordpress_resolve_create_status;
...
final class ContentSafetyTest extends TestCase
{
    ...
    {
        ElementorMCP_Test_State::add_post_type($post_type, public: true, show_in_rest: true);
    ...
    {
        ElementorMCP_Test_State::add_post_type('acme_internal', public: false, show_in_rest: false);
    ...
    {
        ElementorMCP_Test_State::add_post_type('acme_docs', public: false, show_in_rest: true);
    ...
    {
        ElementorMCP_Test_State::add_post_type('post');
        ElementorMCP_Test_State::$capabilities = ['read'];
    ...
    {
        ElementorMCP_Test_State::add_post_type('portfolio', capabilities: [
    ...
    public function testCustomPostTypeCapabilityIsAcceptedWhenHeld(): void
    {
        ...
        ElementorMCP_Test_State::$capabilities = ['edit_portfolios'];
    ...
    public function testAssigningAnotherAuthorNeedsEditOthersPosts(): void
    {
        ElementorMCP_Test_State::add_post_type('post');
        ElementorMCP_Test_State::$capabilities = ['edit_posts'];
        ElementorMCP_Test_State::$current_user_id = 7;
    ...
    {
        register_core_ability('elementor-mcp/create-post', ['label' => 'Create']);

        self::assertSame(['elementor-mcp/create-post'], ElementorMCP_Test_State::$registered_abilities);
    }
    ...
    {
        register_core_ability('elementor-mcp/create-post', ['label' => 'Free']);
        register_core_ability('elementor-mcp/create-post', ['label' => 'Pro']);

        self::assertCount(1, ElementorMCP_Test_State::$registrations);
        self::assertSame('Free', ElementorMCP_Test_State::$registrations[0]['args']['label']);
    }
    ...
    {
        ElementorMCP_Test_State::$registered_abilities = ['elementor-mcp/elementor-set-content'];

        self::assertStringContainsString(
            'elementor-mcp/elementor-set-content',
            builder_remedy('elementor-mcp/elementor-set-content', 'Elementor'),
        );
    }
    ...
    {
        $remedy = builder_remedy('elementor-mcp/elementor-set-content', 'Elementor');

        self::assertStringNotContainsString('elementor-mcp/elementor-set-content', $remedy);
        self::assertStringContainsString('Elementor', $remedy);
    }
    ...
    public function testBuilderMetaRejectionDoesNotNameAnAbsentAbility(): void
    {
        ...
        self::assertStringNotContainsString('elementor-mcp/elementor-set-content', $error->get_error_message());
    ...
    public function testBuilderMetaRejectionNamesTheAbilityWhenRegistered(): void
    {
        ...
        self::assertInstanceOf(WP_Error::class, $error);
        self::assertStringContainsString('elementor-mcp/elementor-set-content', $error->get_error_message());
    }
    ...
    {
        ElementorMCP_Test_State::set_post_meta(12, $key, $value);
    ...
    {
        ElementorMCP_Test_State::set_post_meta(12, '_elementor_edit_mode', '0');
    ...
    {
        ElementorMCP_Test_State::set_post_meta(12, '_elementor_edit_mode', 'editor');
    ...
    {
        ElementorMCP_Test_State::set_post_meta(12, '_elementor_edit_mode', 'builder');
