...
final class DesignSpecTest extends TestCase
{
    ...
    private static function spec(array $overrides = []): array
    {
        return [
            ...
            'container' => 1380,
            'section_padding' => 144,
            'surfaces' => ['paper' => '#f6f3ed', 'ink' => '#0b1220', 'teal' => '#007a78'],
            'type' => [
    ...
    public function test_a_spec_without_surfaces_is_refused(): void
    {
        ...
        self::assertSame('elementor_mcp_spec_surfaces', $result->get_error_code());
    }
    ...
    public function test_a_spec_without_a_type_scale_is_refused(): void
    {
        ...
        self::assertInstanceOf(\WP_Error::class, $result);
        self::assertSame('elementor_mcp_spec_type', $result->get_error_code());
    }
    ...
    public function test_a_spec_without_sections_is_refused(): void
    {
        ...
        self::assertInstanceOf(\WP_Error::class, $result);
        self::assertSame('elementor_mcp_spec_sections', $result->get_error_code());
    }
    ...
    public function test_a_section_on_an_undeclared_surface_is_refused(): void
    {
        ...
        self::assertInstanceOf(\WP_Error::class, $result);
        self::assertSame('elementor_mcp_spec_section_surface', $result->get_error_code());
    }
    ...
    public function test_a_type_role_without_a_size_is_refused(): void
    {
        ...
        self::assertInstanceOf(\WP_Error::class, $result);
        self::assertSame('elementor_mcp_spec_type_size', $result->get_error_code());
    }
    ...
    public function test_a_valid_spec_normalizes(): void
    {
        ...
        self::assertSame('#f6f3ed', $result['surfaces']['paper']);
    ...
    public function test_every_surface_layout_and_type_role_is_generated(): void
    {
        ...
        self::assertArrayHasKey('body-on-teal', $roles);
    }
    ...
    /**
     * A design that chose a near-black ink and a warm off-white chose them for
     * each other. The foreground is picked from the spec's own surfaces, but it
     * still has to clear 4.5:1: ink on this teal is only 3.62:1, while paper on
     * teal is 4.68:1.
     */
    public function test_text_on_a_surface_uses_a_declared_colour(): void
    {
        ...
        self::assertSame('#f6f3ed', $roles['h1-on-ink']['styles']['color']);
        self::assertSame('#f6f3ed', $roles['h1-on-teal']['styles']['color']);
    }
    ...
    public function test_an_item_cannot_be_both_shorthand_and_composed(): void
    {
        ...
        self::assertInstanceOf(\WP_Error::class, $result);
        self::assertSame('elementor_mcp_spec_item_hybrid', $result->get_error_code());
    }
    ...
    public function test_an_undeclared_variant_is_refused(): void
    {
        ...
        self::assertInstanceOf(\WP_Error::class, $result);
        self::assertSame('elementor_mcp_spec_item_variant', $result->get_error_code());
    }
    ...
    public function test_an_unknown_block_layout_is_refused(): void
    {
        ...
        self::assertInstanceOf(\WP_Error::class, $result);
        self::assertSame('elementor_mcp_spec_block_layout', $result->get_error_code());
    }
    ...
    public function test_every_surface_gets_an_inner_card_role(): void
    {
        ...
        foreach (['paper', 'ink', 'teal'] as $surface) {
    ...
    public function test_a_composition_is_refused_for_the_same_reasons_a_spec_is(): void
    {
        ...
        self::assertSame('elementor_mcp_spec_item_hybrid', $hybrid->get_error_code());

        $unknown = Spec\normalize_composition([['type' => 'carousel']]);
        self::assertInstanceOf(\WP_Error::class, $unknown);
        self::assertSame('elementor_mcp_spec_block_type', $unknown->get_error_code());
    }
    ...
    public function test_a_tag_outside_the_outline_is_refused(): void
    {
        ...
        self::assertInstanceOf(\WP_Error::class, $result);
        self::assertSame('elementor_mcp_spec_block_tag', $result->get_error_code());
    }
}
