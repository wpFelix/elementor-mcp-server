...
use function ElementorMCP\Mcp\ability_for_tool;
use function ElementorMCP\Mcp\advertise_confirmation;
use function ElementorMCP\Mcp\empty_input_for;
use function ElementorMCP\Mcp\is_mcp_route;
use function ElementorMCP\Mcp\normalize_schema;
use function ElementorMCP\Mcp\tool_name;
...
final class TransportTest extends TestCase
{
    ...
    {
        return [
            'elementor-mcp endpoint' => ['/mcp/elementor-mcp'],
            'elementor-mcp subpath' => ['/mcp/elementor-mcp/messages'],
    ...
    /**
     * The dispatcher must not intercept Elementor MCP's own REST surface or the OAuth
    ...
    {
        return [
            'oauth' => ['/mcp/elementor-mcp-oauth'],
            'oauth subpath' => ['/mcp/elementor-mcp-oauth/token'],
            'elementor-mcp rest' => ['/elementor-mcp/v1/run'],
            'wp core' => ['/wp/v2/posts'],
            'prefix lookalike' => ['/mcp/elementor-mcp-other'],
            'root' => ['/'],
        ];
    }
    ...
    {
        return [
            'namespaced' => ['elementor-mcp/create-post', 'elementor_mcp_create_post'],
            'multi hyphen' => ['elementor-mcp/list-menu-locations', 'elementor_mcp_list_menu_locations'],
     ...
     * differs by ability. One declaring ELEMENTOR_MCP_NO_INPUT_SCHEMA validates its
    ...
    {
        $ability = new WP_Ability('elementor-mcp/list-content', [
