...
use function ElementorMCP\Telemetry\decided;
use function ElementorMCP\Telemetry\enabled;
use function ElementorMCP\Telemetry\install_id;
use function ElementorMCP\Telemetry\payload;
use function ElementorMCP\Telemetry\set_enabled;

use const ElementorMCP\Telemetry\CRON_HOOK;
...
final class TelemetryConsentTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        ElementorMCP_Test_State::$cron = [];
        ElementorMCP_Test_State::$http_posts = [];
    }
    ...
    {
        \ElementorMCP\Telemetry\send('ping');

        self::assertSame([], ElementorMCP_Test_State::$http_posts);
    }
    ...
    {
        set_enabled(false);
        ElementorMCP_Test_State::next_request();
    ...
    public function test_opting_out_sends_one_final_deletion_request(): void
    {
        ...
        self::assertCount(1, ElementorMCP_Test_State::$http_posts);

        $sent = json_decode((string) ElementorMCP_Test_State::$http_posts[0]['body'], associative: true);
