...
use ElementorMCP\Design\Context;
...
final class DesignContextTest extends TestCase
{
    ...
    public function test_the_cold_start_names_the_way_out(): void
    {
        ...
        self::assertStringContainsString('elementor-mcp/generate-design', $block);
        self::assertStringContainsString('elementor-mcp/adopt-design-from-site', $block);
        self::assertStringContainsString('elementor-mcp/save-design', $block);
    }
