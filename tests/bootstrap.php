 ...
 * Unit-test bootstrap.
 *
 * These are unit tests, not WordPress integration tests: they exercise Elementor MCP's
...
// abilities read them to refuse deactivating or deleting Elementor MCP itself, so the
// suite needs them to exercise that refusal.
define('ELEMENTOR_MCP_PLUGIN_FILE', ABSPATH . 'wp-content/plugins/elementor-mcp/elementor-mcp.php');
define('ELEMENTOR_MCP_PRO_FILE', ABSPATH . 'wp-content/plugins/elementor-mcp-pro/elementor-mcp-pro.php');
...
// The Free prompt tier is a contractual product boundary: exactly ten
// industry starters, with deeper packs supplied only by Pro's filter.
...
// Snapshot them before any test calls ElementorMCP_Test_State::reset(). The full
...
define('ELEMENTOR_MCP_TEST_BOOT_ABILITIES', ElementorMCP_Test_State::$registered_abilities);
define('ELEMENTOR_MCP_TEST_BOOT_REGISTRATIONS', ElementorMCP_Test_State::$registrations);
