 ...
 * every piece of mutable state lives on ElementorMCP_Test_State so a test can set up
 ...
 */
final class ElementorMCP_Test_State
{
    ...
    public static bool $elementor_mcp_enabled = true;
    ...
    public static function reset(): void
    {
        ...
        self::$taxonomies = [];
        self::$logged_in = true;
        self::$elementor_mcp_enabled = true;
...
if (!function_exists('get_post_type_object')) {
    ...
    {
        return ElementorMCP_Test_State::$post_types[$post_type] ?? null;
    }
}
...
if (!function_exists('post_type_exists')) {
    ...
    {
        return isset(ElementorMCP_Test_State::$post_types[$post_type]);
    }
}
...
if (!function_exists('current_user_can')) {
    ...
    {
        return in_array($capability, ElementorMCP_Test_State::$capabilities, true);
    }
}
...
if (!function_exists('get_post')) {
    ...
    {
        $post = ElementorMCP_Test_State::$posts[$post_id] ?? null;
        if ($post === null) {
            return null;
        }
...
if (!function_exists('get_post_meta')) {
    ...
    {
        $meta = ElementorMCP_Test_State::$post_meta[$post_id] ?? [];
...
if (!function_exists('wp_get_post_revision')) {
    ...
    {
        return ElementorMCP_Test_State::$revisions[$post] ?? null;
    }
}
...
if (!function_exists('wp_restore_post_revision')) {
    ...
    {
        return ElementorMCP_Test_State::$restore_result;
    }
}
...
if (!function_exists('get_current_user_id')) {
    ...
    {
        return ElementorMCP_Test_State::$current_user_id;
    }
}
...
if (!function_exists('wp_has_ability')) {
    ...
    {
        return in_array($name, ElementorMCP_Test_State::$registered_abilities, true);
    }
}
...
if (!function_exists('wp_register_ability')) {
    ...
    {
        ElementorMCP_Test_State::$registered_abilities[] = $name;
        ElementorMCP_Test_State::$registrations[] = ['name' => $name, 'args' => $args];
    }
}
...
if (!function_exists('is_user_logged_in')) {
    ...
    {
        return ElementorMCP_Test_State::$logged_in;
    }
}

if (!function_exists('elementor_mcp_is_enabled')) {
    function elementor_mcp_is_enabled(): bool
    {
        return ElementorMCP_Test_State::$elementor_mcp_enabled;
    }
}
...
if (!function_exists('get_taxonomy')) {
    ...
    {
        return ElementorMCP_Test_State::$taxonomies[$taxonomy] ?? false;
    }
}
...
if (!function_exists('is_multisite')) {
    ...
    {
        return ElementorMCP_Test_State::$multisite;
    }
}
...
if (!function_exists('get_plugins')) {
    ...
    {
        return ElementorMCP_Test_State::$plugins;
    }
}
...
if (!function_exists('get_home_url')) {
    ...
    {
        return 'https://elementormcp.test' . $path;
    }
}
...
if (!class_exists('WP_Ability')) {
     ...
     *
     * Elementor MCP's risk classification, confirmation gate, and MCP tool listing all
...
if (!function_exists('get_option')) {
    ...
    {
        return array_key_exists($option, ElementorMCP_Test_State::$options)
            ? ElementorMCP_Test_State::$options[$option]
            : $default_value;
    }
}
...
if (!function_exists('add_option')) {
    ...
    {
        if (array_key_exists($option, ElementorMCP_Test_State::$options)) {
            return false;
        }

        ElementorMCP_Test_State::$options[$option] = $value;
...
if (!function_exists('update_option')) {
    ...
    function update_option(string $option, mixed $value, mixed $autoload = null): bool
    {
        ...
        if ($old_value === false && !array_key_exists($option, ElementorMCP_Test_State::$options)) {
...
if (!function_exists('delete_option')) {
    function delete_option(string $option): bool
    {
        ...
        unset(ElementorMCP_Test_State::$options[$option]);
        return true;
    }
}
...
if (!function_exists('wp_salt')) {
    ...
    {
        return 'elementor-mcp-test-salt-' . $scheme;
    }
}
...
if (!function_exists('wp_get_nav_menu_object')) {
    ...
    {
        return in_array($menu_id, ElementorMCP_Test_State::$nav_menus, true)
...
if (!function_exists('is_object_in_term')) {
    function is_object_in_term(int $object_id, string $taxonomy, int $term_id): bool|WP_Error
    {
        return $taxonomy === 'nav_menu'
            && in_array($term_id, ElementorMCP_Test_State::$nav_menu_memberships[$object_id] ?? [], true);
    }
}
...
if (!function_exists('wp_update_nav_menu_item')) {
    ...
    {
        ElementorMCP_Test_State::$nav_menu_updates[] = compact('menu_id', 'item_id', 'args');
...
if (!function_exists('wp_next_scheduled')) {
    ...
    {
        return ElementorMCP_Test_State::$cron[$hook] ?? false;
    }
}
...
if (!function_exists('wp_schedule_event')) {
    ...
    {
        ElementorMCP_Test_State::$cron[$hook] = $timestamp;
...
if (!function_exists('wp_clear_scheduled_hook')) {
    ...
    {
        $existed = isset(ElementorMCP_Test_State::$cron[$hook]);
        unset(ElementorMCP_Test_State::$cron[$hook]);
...
if (!function_exists('wp_remote_post')) {
    ...
    {
        ElementorMCP_Test_State::$http_posts[] = ['url' => $url, 'body' => $args['body'] ?? null];
