...
foreach ($slugs as $slug) {
    ...
    $bg = $vars['--elementor-mcp-bg'] ?? '';
    $ink = $vars['--elementor-mcp-ink'] ?? '';
    $accent = $vars['--elementor-mcp-accent'] ?? '';
    $heading = strtolower($vars['--elementor-mcp-font-heading'] ?? '');
    $body = strtolower($vars['--elementor-mcp-font-body'] ?? '');
