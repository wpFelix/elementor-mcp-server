...
require_once __DIR__ . '/typefaces.php';
...
require_once __DIR__ . '/abilities/list-typefaces.php';
...
add_action('wp_abilities_api_init', __NAMESPACE__ . '\Abilities\Typefaces\register', priority: 999);
...
add_filter('elementor_mcp_settings_sections', __NAMESPACE__ . '\Gate\register_setting');
add_filter('elementor_mcp_pre_ability_execute', __NAMESPACE__ . '\Gate\filter_pre_ability_execute', priority: 7, accepted_args: 3);
add_filter('mcp_adapter_pre_tool_call', __NAMESPACE__ . '\Gate\filter_pre_mcp_tool_call', priority: 7, accepted_args: 2);
add_filter('elementor_mcp_modern_mcp_pre_ability_execute', __NAMESPACE__ . '\Gate\filter_pre_ability_execute', priority: 7, accepted_args: 3);
...
add_filter('elementor_mcp_discover_abilities_instructions', __NAMESPACE__ . '\Context\inject', priority: 11);
