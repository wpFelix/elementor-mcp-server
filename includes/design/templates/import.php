...
if (!Admin\current_user_can_manage()) {
    wp_die(esc_html__('You do not have permission to import designs.', domain: 'elementor-mcp'));
}
...
<div class="wrap elementor-mcp-design">
    ...
    <p class="elementor-mcp-design-import-trust"><?php esc_html_e(
    ...
    <form
        ...
        class="elementor-mcp-design-import"
        ...
        ; ?>');"
    >
        <?php wp_nonce_field('elementor_mcp_design_import'); ?>
        <input type="hidden" name="action" value="elementor_mcp_design_import" />
        <p>
            <label><?php esc_html_e('Upload a .md file:', domain: 'elementor-mcp'); ?>
                <input type="file" name="design_file" accept=".md" />
            </label>
        </p>
        <p><?php esc_html_e('…or paste the DESIGN.md below:', domain: 'elementor-mcp'); ?></p>
        <p>
            <textarea
                name="design_content"
                rows="14"
        ...
        <p>
            <label><input type="checkbox" name="activate" value="1" />
                <?php esc_html_e('Activate after import', domain: 'elementor-mcp'); ?></label>
        </p>
        <p>
