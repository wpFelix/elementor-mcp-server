...
namespace ElementorMCP\Design\Cpt;

if (!defined('ABSPATH')) {
    exit();
}

const POST_TYPE = 'elementor_mcp_design';

/** Option holding the active design slug. Empty string = none active. */
const OPTION_ACTIVE = 'elementor_mcp_active_design';
...
function register(): void
{
    ...
    register_post_type(POST_TYPE, [
        'label' => __('Designs', domain: 'elementor-mcp'),
        'public' => false,
        'show_ui' => false,
        'show_in_rest' => false,
        'has_archive' => false,
        'rewrite' => false,
        'capability_type' => ['elementor_mcp_design', 'elementor_mcp_designs'],
        'map_meta_cap' => true,
        'capabilities' => [
            'read' => $capability,
