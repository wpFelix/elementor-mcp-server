...
namespace ElementorMCP\Design\Preflight;
...
function checked(bool $has_active): array
{
     ...
     */
    $extra = apply_filters('elementor_mcp_design_checked', [], $has_active);
...
function violations(string $output, array $ctx): array
{
     ...
     */
    $extra = apply_filters('elementor_mcp_design_violations', $out, $output, $ctx);
