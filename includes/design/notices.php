...
namespace ElementorMCP\Design\Notices;
...
const RELOAD_NOTICE_TRANSIENT = 'elementor_mcp_design_pending_reload_notice';
...
function render(): void
{
    ...
    $inline_key = 'elementor_mcp_design_admin_notice_' . get_current_user_id();
    ...
    if (!$screen instanceof \WP_Screen || $screen->id !== 'elementor-mcp_page_' . Admin\PAGE_SLUG) {
        return;
    }
