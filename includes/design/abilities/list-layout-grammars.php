...
namespace ElementorMCP\Design\Abilities\Grammars;
...
function register(): void
{
    ...
    wp_register_ability('elementor-mcp/list-layout-grammars', [
        'label' => __('List Layout Grammars', domain: 'elementor-mcp'),
        'description' => __(
        ...
        'execute_callback' => static function (array $input): array|WP_Error {
            ...
            if ($name !== '') {
                ...
                if ($grammar === null) {
                    return new WP_Error(
                        'elementor_mcp_unknown_grammar',
                        sprintf(
                            /* translators: 1: requested name, 2: comma-separated grammar names */
                            __('"%1$s" is not a layout grammar. Available: %2$s.', domain: 'elementor-mcp'),
                            $name,
                            implode(', ', Grammars\names()),
                        ),
