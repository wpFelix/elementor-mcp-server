...
namespace ElementorMCP\Design\Abilities\Examples;
...
function register(): void
{
    ...
    wp_register_ability('elementor-mcp/list-design-examples', [
        ...
        'execute_callback' => static function (array $input): array|WP_Error {
            ...
            if ($record === null) {
                return new WP_Error(
                    'elementor_mcp_example_not_found',
                    sprintf(
                        /* translators: 1: requested slug, 2: comma-separated list of valid slugs. */
                        __('No example named %1$s. Available: %2$s.', domain: 'elementor-mcp'),
                        $slug,
            ...
            return [
                ...
                'next_step' => __(
                    'To use it, adapt it: change the palette and faces to this site\'s brand, rewrite the reasoning for this business, then save with elementor-mcp/save-design. Saving it verbatim gives the site a design that was argued for somebody else.',
                    domain: 'elementor-mcp',
                ),
            ];
        },
