...
namespace ElementorMCP\Design\Abilities\GenerateDesign;

use WP_Error;
use ElementorMCP\Design\Abilities;
use ElementorMCP\Design\Contrast;
use ElementorMCP\Design\Generate;
...
function register(): void
{
    ...
    wp_register_ability('elementor-mcp/generate-design', [
        'label' => __('Generate Design', domain: 'elementor-mcp'),
        'description' => __(
        ...
        'execute_callback' => static function (array $input): array|WP_Error {
            ...
            return [
                ...
                'next' => __(
                    'Read it, change what the brand actually requires, then save with elementor-mcp/save-design. A derived value you keep is still a decision; a derived value you cannot justify should be overridden rather than shipped. To make the design reproducible rather than merely written down, pass "spec_type" straight into elementor-mcp/save-design-spec as the spec\'s type scale.',
                    domain: 'elementor-mcp',
                ),
            ];
        },
