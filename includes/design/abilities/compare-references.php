...
namespace ElementorMCP\Design\Abilities\CompareReferences;
...
function register(): void
{
    ...
    wp_register_ability('elementor-mcp/compare-references', [
        'label' => __('Compare References', domain: 'elementor-mcp'),
        'description' => __(
        ...
        'execute_callback' => static function (array $input): array|WP_Error {
            ...
            if (count($observations) < 3) {
                return new WP_Error(
                    'elementor_mcp_references_too_few',
                    __(
