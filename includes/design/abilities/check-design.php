...
namespace ElementorMCP\Design\Abilities\Check;
...
function register(): void
{
    ...
    wp_register_ability('elementor-mcp/check-design', [
        'label' => __('Check Design (Pre-flight)', domain: 'elementor-mcp'),
        'description' => __(
        ...
        'execute_callback' => static function (array $input): array|WP_Error {
            ...
            if (strlen($output) > Parser\MAX_BYTES) {
                return new WP_Error('too_large', __('Output exceeds the size limit.', domain: 'elementor-mcp'));
            }
