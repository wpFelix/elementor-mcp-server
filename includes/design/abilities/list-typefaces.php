...
namespace ElementorMCP\Design\Abilities\Typefaces;
...
function register(): void
{
    ...
    wp_register_ability('elementor-mcp/list-typefaces', [
        'label' => __('List Typefaces', domain: 'elementor-mcp'),
        'description' => __(
        ...
        'execute_callback' => static function (array $input): array|WP_Error {
            ...
            if (($input['pairs_with'] ?? '') !== '') {
                ...
                if (Typefaces\get($anchor) === null) {
                    return new WP_Error(
                        'elementor_mcp_unknown_typeface',
                        sprintf(
