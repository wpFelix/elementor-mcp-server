...
/**
 * Elementor MCP Chat: admin workbench and REST API.
 *
...
// Priority 70 places Chat directly before Visual (80) in the Elementor MCP submenu.
add_action('admin_menu', callback: 'elementor_mcp_register_chat_menu', priority: 70);
add_action('admin_enqueue_scripts', callback: 'elementor_mcp_enqueue_chat_assets');
add_action('rest_api_init', callback: 'elementor_mcp_register_chat_routes');
