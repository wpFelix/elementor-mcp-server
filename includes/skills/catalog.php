...
namespace ElementorMCP\Skills\Catalog;
...
/**
 * Prepend the unified skill catalog block to the Elementor MCP discover-abilities
 ...
 * `elementor_mcp_skill_lookup_sources` automatically appear here under their
 * source label.
 */
...
function render(array $skills): string
{
    $lines = [
        ...
        '',
        'If a listed skill matches the request, load its full instructions with `elementor-mcp/skill-get` before starting the work — not after.',
        '',
    ];
