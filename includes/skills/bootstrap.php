...
// Skills is registered as a submenu under the Elementor MCP top-level menu;
// run after Elementor MCP's main menu callback (priority 10) attaches the
// parent slug `elementor-mcp-connect`.
...
add_filter('elementor_mcp_skill_lookup_sources', __NAMESPACE__ . '\\BuiltIn\\register');
add_filter('elementor_mcp_discover_abilities_instructions', __NAMESPACE__ . '\\Catalog\\inject', priority: 10);
