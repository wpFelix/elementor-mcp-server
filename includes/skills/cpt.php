...
namespace ElementorMCP\Skills\Cpt;

if (!defined('ABSPATH')) {
    exit();
}

const POST_TYPE = 'elementor_mcp_skill';
...
function register(): void
{
    ...
    register_post_type(POST_TYPE, [
        ...
        'has_archive' => false,
        'rewrite' => false,
        'capability_type' => ['elementor_mcp_skill', 'elementor_mcp_skills'],
        'map_meta_cap' => true,
        'capabilities' => [
            'read' => $capability,
    ...
    $auth = static fn(): bool => \elementor_mcp_current_user_can_manage();
