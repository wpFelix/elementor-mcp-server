...
namespace ElementorMCP\Skills\Abilities\SkillDelete;
...
function register(): void
{
    ...
    wp_register_ability('elementor-mcp/skill-delete', [
        'label' => __('Delete Skill', domain: 'elementor-mcp'),
        'description' => __(
            'Move a Elementor MCP user skill to trash. Pass `permanent=true` to skip trash and delete immediately.',
