...
namespace ElementorMCP\Skills\Abilities;
...
function register_categories(): void
{
    ...
    wp_register_ability_category('skill', [
        'label' => __('Skills', domain: 'elementor-mcp'),
        'description' => __('Manage and load Elementor MCP skills.', domain: 'elementor-mcp'),
    ]);
}

namespace ElementorMCP\Skills\Abilities\SkillGet;
...
/**
 * Take canonical ownership of `elementor-mcp/skill-get`. Registered at
 ...
 * (`elementor_mcp_skill_lookup_sources`), the fallback path stops firing
...
function register(): void
{
    ...
    $previous = wp_has_ability('elementor-mcp/skill-get') ? wp_get_ability('elementor-mcp/skill-get') : null;
    if ($previous instanceof \WP_Ability) {
        wp_unregister_ability('elementor-mcp/skill-get');
    }

    wp_register_ability('elementor-mcp/skill-get', [
        'label' => __('Get Skill', domain: 'elementor-mcp'),
        'description' => __(
            'Load a Elementor MCP skill by slug. Returns the full SKILL.md content plus metadata.',
...
function normalize_requested_slug(string $slug): string
{
    ...
    if (str_starts_with($normalized, 'elementor-mcp/')) {
        return substr($normalized, strlen('elementor-mcp/'));
    }
