 ...
 */
function elementor_mcp_get_active_languages()
{
    // WPML.
 ...
 * working mode before content/layout work. Elementor is the only page-builder
 * surface; other integrations remain available for their own content, SEO,
 * forms, commerce, and site-management workflows.
 *
 * @return list<string>
 */
function elementor_mcp_build_building_context_lines(): array
{
    $theme = wp_get_theme();
    ...
    return [
        ...
        '',
        'Before any visual work (building or restyling a page, template, section, or component), load the `elementor-mcp-design` skill and follow it.',
        '',
        'Before building or restructuring a page\'s content or layout, use the Elementor MCP skills and Elementor abilities. Do not substitute another page builder, block editor, or theme-template authoring surface for the Elementor workflow.',
    ];
}
 ...
 * @return string
 */
function elementor_mcp_build_server_instructions()
{
    $lines = [
        'Elementor MCP gives you unrestricted control over this WordPress installation.',
        '',
        '## Environment',
        '',
    ...
    $multilingual = elementor_mcp_get_active_languages();
    ...
    $lines = array_merge($lines, elementor_mcp_build_building_context_lines());
