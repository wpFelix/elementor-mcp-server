 ...
 *
 * Declared for completeness of the vocabulary. Elementor MCP never returns it: no
 ...
 *
 * Deliberately short. A Elementor MCP tool list changes whenever an administrator
...
/**
 * Cache visibility for every Elementor MCP result.
 *
 ...
 * sensitive. Elementor MCP's surface fails that test in three independent ways: the
