 ...
 *
 * Elementor MCP is a dual-era MCP server. The vendored MCP Adapter implements the
 ...
 * Elementor MCP does not advertise revisions it has not verified against this build.
 *
 * @var list<string>
 */
