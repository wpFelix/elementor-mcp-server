...
namespace ElementorMCP\OAuth\Keys;
...
const PRIVATE_KEY_OPTION = 'elementor_mcp_oauth_private_key';

const ENCRYPTION_KEY_OPTION = 'elementor_mcp_oauth_encryption_key';
...
function configuration_hint(array $configs_tried): string
{
    ...
    $sentences[] = 'To create the keys now from a PHP environment that does work, run: wp elementor-mcp oauth-keys generate.';
