 ...
 * verifier cannot drift. Matches the server route registered in elementor-mcp.php and advertised by the
 * protected-resource metadata.
 */
function resource_identifier(): string
{
    return rest_url('mcp/elementor-mcp-oauth');
}
 ...
 * Elementor MCP switched to one full-access grant.
 *
 * @return list<string>
 */
