...
namespace ElementorMCP\OAuth\Endpoints\Discovery;
...
{
    return [
        'resource' => \ElementorMCP\OAuth\resource_identifier(),
        'authorization_servers' => [home_url()],
        'bearer_methods_supported' => ['header'],
        'scopes_supported' => ['mcp'],
        'elementor-mcp' => \elementor_mcp_server_compatibility(),
    ];
}
...
{
    $base = rest_url('elementor-mcp/v1/oauth');
    ...
    return [
        'issuer' => home_url(),
        'authorization_endpoint' => admin_url('admin.php?page=elementor-mcp-oauth-authorize'),
...
function maybe_serve(): void
{
    ...
    $paths = discovery_paths(home_url(), \ElementorMCP\OAuth\resource_identifier());
