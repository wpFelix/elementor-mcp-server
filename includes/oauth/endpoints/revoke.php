...
namespace ElementorMCP\OAuth\Endpoints\Revoke;
...
use ElementorMCP\OAuth\Repositories\AccessTokenRepository;
use ElementorMCP\OAuth\Repositories\RefreshTokenRepository;
...
{
    register_rest_route('elementor-mcp/v1', route: '/oauth/revoke', args: [
        'methods' => 'POST',
