...
wp_register_ability('elementor-mcp/execute-php', [
    'label' => __('Execute PHP Code', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'elementor_mcp_execute_php',
    ...
    'meta' => [
        ...
        'annotations' => [
            'instructions' => implode("\n", [
                ...
                '- Execution has a ' . ELEMENTOR_MCP_MAX_EXECUTION_TIME . ' second time limit.',
                '',
                'SANDBOX CONTEXT:',
                '- To create persistent PHP functionality, write files to the sandbox',
                '  (wp-content/elementor-mcp-sandbox/) using the write-file ability.',
 ...
 */
function elementor_mcp_execute_php($input)
{
    ...
    set_time_limit(ELEMENTOR_MCP_MAX_EXECUTION_TIME);
