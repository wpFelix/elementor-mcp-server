...
wp_register_ability('elementor-mcp/edit-file', [
    'label' => __('Edit File', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'elementor_mcp_edit_file',
 ...
 */
function elementor_mcp_edit_replace_first(string $content, string $old_string, string $new_string): string
{
 ...
 */
function elementor_mcp_edit_file($input)
{
    ...
    $new_content = $replace_all
        ...
        : elementor_mcp_edit_replace_first($content, $old_string, $new_string);
