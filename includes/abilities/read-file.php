...
wp_register_ability('elementor-mcp/read-file', [
    'label' => __('Read File', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'elementor_mcp_read_file',
 ...
 */
function elementor_mcp_read_file($input)
{
    $resolved = elementor_mcp_resolve_path(path: (string) $input['path'], must_exist: true);
    ...
    $is_text = elementor_mcp_is_text_mime_type($mime_type) && mb_check_encoding(value: $content, encoding: 'UTF-8');
 ...
 * @return bool
 */
function elementor_mcp_is_text_mime_type($mime_type)
{
