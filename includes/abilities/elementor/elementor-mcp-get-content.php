...
wp_register_ability('elementor-mcp/elementor-get-content', [
    'label' => __('Get Elementor Content', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'output_schema' => [
        ...
        'properties' => [
            ...
            'has_element_cache' => [
                'type' => 'boolean',
                'description' => 'True when Elementor Pro would serve a cached render for this document, so a programmatic edit will not show on the front end until the cache is cleared with elementor-mcp/elementor-clear-document-cache.',
            ],
            'cache_expires_at' => [
                'type' => 'integer',
    ...
    'execute_callback' => 'ElementorMCP\Abilities\Elementor\elementor_get_content',
