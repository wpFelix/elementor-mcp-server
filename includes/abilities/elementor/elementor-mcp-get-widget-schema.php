...
wp_register_ability('elementor-mcp/elementor-get-schema', [
    'label' => __('Get Elementor Widget Schema', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'ElementorMCP\Abilities\Elementor\elementor_get_schema',
 ...
 */
const ELEMENTOR_MCP_LIST_SKIP_WIDGETS = ['common', 'common-base', 'common-optimized', 'global'];
...
function schema_list_overview(): array
{
    ...
    foreach (ELEMENTOR_MCP_ATOMIC_CONTAINER_TYPES as $atomic_type) {
...
{
    if (in_array($name, ELEMENTOR_MCP_LIST_SKIP_WIDGETS, strict: true)) {
        return false;
    }
