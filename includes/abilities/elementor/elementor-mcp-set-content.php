...
wp_register_ability('elementor-mcp/elementor-set-content', [
    ...
    'execute_callback' => 'ElementorMCP\Abilities\Elementor\elementor_set_content',
    'permission_callback' => 'elementor_mcp_permission_callback',
    'meta' => [
        'show_in_rest' => true,
        'mcp' => ['public' => true, 'type' => 'tool'],
        'annotations' => [
            'instructions' => 'Each element accepts either the add-element-style keys (element_type + widget_type) or the native Elementor keys (elType + widgetType) — both work. Top-level containers use element_type="container" or elType="container". Widgets use element_type="widget" + widget_type="heading" (or elType="widget" + widgetType="heading"). Children go in the "elements" array. Settings shape depends on the widget/container type — use elementor-mcp/elementor-get-schema to inspect it. IDs are 7-char hex; provide your own or let them be auto-generated. Atomic v4 widgets auto-wrap scalar values into the $$type envelope — both for settings and inside per-element styles\' variant props.',
            'readonly' => false,
            'destructive' => true,
            'idempotent' => true,
        ],
 ...
 */
function elementor_prepare_content(array $content): array
{
    $assigned = [];
...
function elementor_set_content(array $input): array
{
    ...
    $prepared = elementor_prepare_content($content);
