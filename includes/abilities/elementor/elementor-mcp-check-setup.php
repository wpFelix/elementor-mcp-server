...
wp_register_ability('elementor-mcp/elementor-check-setup', [
    'label' => __('Check Elementor Setup', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'ElementorMCP\\Abilities\\Elementor\\elementor_check_setup',
...
function el_check_setup_issues(array $elementor, array $elementor_pro, array $atomic): array
{
    ...
    if (!$elementor['min_version_met']) {
        $issues[] = sprintf(
            ...
            $elementor['version'],
            ELEMENTOR_MCP_MINIMUM_ELEMENTOR_VERSION,
        );
    }
