...
/**
 * Base Elementor runtime required by every Free Elementor ability.
 */
function el_min_runtime_available(): bool
{
    return (
        defined('ELEMENTOR_VERSION')
        && version_compare(el_elementor_version(), version2: ELEMENTOR_MCP_MINIMUM_ELEMENTOR_VERSION, operator: '>=')
...
// ONLY while Elementor MCP is active, so a page authored with a div/span-tagged
// e-heading is invalid under stock Elementor's atomic schema. Exported as a
// template and imported on a site without Elementor MCP, Document::save runs
...
// regressing existing users who have Elementor MCP switched on — while the front
