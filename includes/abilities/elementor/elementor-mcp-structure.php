 ...
 * a half-applied edit.
 *
 * @param callable(list<array<string, mixed>> &$elements): null|string $mutate
...
wp_register_ability('elementor-mcp/elementor-move-element', [
    'label' => __('Move Elementor Element', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'ElementorMCP\Abilities\Elementor\elementor_move_element',
...
wp_register_ability('elementor-mcp/elementor-duplicate-element', [
    'label' => __('Duplicate Elementor Element', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'ElementorMCP\Abilities\Elementor\elementor_duplicate_element',
    'permission_callback' => 'elementor_mcp_permission_callback',
    'meta' => [
        'show_in_rest' => true,
        'mcp' => ['public' => true, 'type' => 'tool'],
...
wp_register_ability('elementor-mcp/elementor-reorder-children', [
    'label' => __('Reorder Elementor Children', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'ElementorMCP\Abilities\Elementor\elementor_reorder_children',
    'permission_callback' => 'elementor_mcp_permission_callback',
    'meta' => [
        'show_in_rest' => true,
        'mcp' => ['public' => true, 'type' => 'tool'],
...
wp_register_ability('elementor-mcp/elementor-find-elements', [
    'label' => __('Find Elementor Elements', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'ElementorMCP\Abilities\Elementor\elementor_find_elements',
    'permission_callback' => 'elementor_mcp_permission_callback',
    'meta' => [
        'show_in_rest' => true,
        'mcp' => ['public' => true, 'type' => 'tool'],
