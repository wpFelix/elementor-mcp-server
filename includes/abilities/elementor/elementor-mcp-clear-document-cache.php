...
wp_register_ability('elementor-mcp/elementor-clear-document-cache', [
    'label' => __('Clear Elementor Document Cache', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'ElementorMCP\\Abilities\\Elementor\\elementor_clear_document_cache',
