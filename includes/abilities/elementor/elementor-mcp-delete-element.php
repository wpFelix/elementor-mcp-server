...
wp_register_ability('elementor-mcp/elementor-delete-element', [
    'label' => __('Delete Elementor Element', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'execute_callback' => 'ElementorMCP\Abilities\Elementor\elementor_delete_element',
