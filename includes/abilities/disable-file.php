...
wp_register_ability('elementor-mcp/disable-file', [
    ...
    'input_schema' => [
        ...
        'properties' => [
            'path' => [
                'type' => 'string',
                'description' => 'Path to the sandbox file to disable. Relative paths are resolved from ABSPATH. Must be inside wp-content/elementor-mcp-sandbox/.',
                'minLength' => 1,
            ],
        ],
        'required' => ['path'],
    ...
    'execute_callback' => 'elementor_mcp_disable_file',
    ...
    'meta' => [
        ...
        'annotations' => [
            'instructions' => implode("\n", [
                'SANDBOX NOTES:',
                '- Only files inside wp-content/elementor-mcp-sandbox/ (the PHP sandbox) can be disabled.',
 ...
 */
function elementor_mcp_disable_file($input)
{
    $resolved = elementor_mcp_resolve_path((string) $input['path'], must_exist: true);
