...
namespace ElementorMCP\Abilities\Preview;
...
wp_register_ability('elementor-mcp/preview-ability', [
    'label' => __('Preview Ability', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'input_schema' => [
        ...
        'properties' => [
            'ability_name' => [
                'type' => 'string',
                'description' => 'The ability whose effect you want to see, e.g. "elementor-mcp/update-post".',
            ],
            'input' => [
                'type' => 'object',
    ...
    'meta' => [
        ...
        'annotations' => [
            'instructions' => 'Call this before a write the user has not explicitly approved, especially a delete. '
                ...
                . 'call elementor-mcp/apply-preview with the preview_id — do not re-send the original write, because the '
...
wp_register_ability('elementor-mcp/apply-preview', [
    'label' => __('Apply Preview', domain: 'elementor-mcp'),
    'description' => __(
        'Applies a diff previously produced by elementor-mcp/preview-ability, after checking the target has not changed since. Refuses if it has, so what was approved is what runs.',
        domain: 'elementor-mcp',
    ),
    'category' => 'preview',
    'input_schema' => [
        'type' => 'object',
        'properties' => [
            'preview_id' => ['type' => 'string', 'description' => 'The preview_id returned by elementor-mcp/preview-ability.'],
            'confirm' => [
                'type' => 'boolean',
                'default' => false,
    ...
    'meta' => [
        ...
        'annotations' => [
            'instructions' => 'Runs the write the preview described. The underlying ability is re-checked against the '
                ...
                . 'target changed since the preview was made, this refuses with elementor_mcp_preview_drifted and writes '
                . 'nothing — re-run elementor-mcp/preview-ability and show the user the new diff rather than forcing it '
