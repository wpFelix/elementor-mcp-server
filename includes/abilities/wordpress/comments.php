 ...
 * @var list<string>
 */
const ELEMENTOR_MCP_COMMENT_ACTIONS = ['approve', 'hold', 'spam', 'unspam', 'trash', 'untrash'];

register_core_ability('elementor-mcp/list-comments', [
    'label' => __('List Comments', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/get-comment', [
    'label' => __('Get Comment', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/create-comment', [
    'label' => __('Create Comment', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/update-comment', [
    'label' => __('Update Comment', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/moderate-comment', [
    'label' => __('Moderate Comment', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'input_schema' => [
        ...
        'properties' => [
            'comment_id' => ['type' => 'integer'],
            'action' => ['type' => 'string', 'enum' => ELEMENTOR_MCP_COMMENT_ACTIONS],
        ],
...
register_core_ability('elementor-mcp/delete-comment', [
    'label' => __('Delete Comment', domain: 'elementor-mcp'),
    'description' => __(
        'Permanently deletes a comment, bypassing the trash. This cannot be undone and requires explicit confirmation. To reversibly remove a comment, use elementor-mcp/moderate-comment with action "trash" instead.',
        domain: 'elementor-mcp',
    ),
    'category' => 'wordpress',
    'input_schema' => [
...
function wordpress_moderate_comment(array $input): array|WP_Error
{
    ...
    if (!in_array($action, ELEMENTOR_MCP_COMMENT_ACTIONS, strict: true)) {
...
function wordpress_delete_comment(array $input): array|WP_Error
{
    if (($input['confirm'] ?? false) !== true) {
        return new WP_Error(
            ...
            'Permanent deletion cannot be rolled back. Use elementor-mcp/moderate-comment with action "trash" for a reversible removal, or re-call with confirm: true only after the user has explicitly agreed.',
            ['status' => 422],
        );
    }
