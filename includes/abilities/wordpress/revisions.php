...
register_core_ability('elementor-mcp/list-revisions', [
    'label' => __('List Revisions', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/get-revision', [
    'label' => __('Get Revision', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/restore-revision', [
    'label' => __('Restore Revision', domain: 'elementor-mcp'),
    'description' => __(
