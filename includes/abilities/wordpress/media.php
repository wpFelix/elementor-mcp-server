...
register_core_ability('elementor-mcp/list-media', [
    'label' => __('List Media', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/get-media', [
    'label' => __('Get Media', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/import-media-url', [
    'label' => __('Import Media from URL', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/update-media', [
    'label' => __('Update Media', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/delete-media', [
    'label' => __('Delete Media', domain: 'elementor-mcp'),
    'description' => __(
        'Permanently deletes a Media Library attachment and its generated files. This is irreversible and requires explicit confirmation through Elementor MCP safety enforcement.',
        domain: 'elementor-mcp',
    ),
    'category' => 'wordpress',
    'input_schema' => [
...
function wordpress_get_media(array $input): array|WP_Error
{
    ...
    if (!$attachment instanceof WP_Post || $attachment->post_type !== 'attachment') {
        return new WP_Error('elementor_mcp_media_not_found', __('Media attachment not found.', domain: 'elementor-mcp'));
    }
...
function wordpress_import_media_url(array $input): array|WP_Error
{
    ...
    if ($url === '' || !wp_http_validate_url($url)) {
        return new WP_Error('elementor_mcp_invalid_media_url', __(
            'A safe, public HTTP(S) URL is required.',
            domain: 'elementor-mcp',
        ));
    }
    // These are WordPress core files, not Elementor MCP's. The middle one was
    // 'elementor-mcp-media.php' — a rebrand find-and-replace that renamed a core
...
function wordpress_delete_media(array $input): array|WP_Error
{
    ...
    if (wp_delete_attachment($attachment_id, force_delete: true) === false) {
        return new WP_Error('elementor_mcp_media_delete_failed', __(
