...
register_core_ability('elementor-mcp/set-featured-image', [
    'label' => __('Set Featured Image', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/remove-featured-image', [
    'label' => __('Remove Featured Image', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/attach-media', [
    'label' => __('Attach Media', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/detach-media', [
    'label' => __('Detach Media', domain: 'elementor-mcp'),
    'description' => __(
