...
register_core_ability('elementor-mcp/list-content', [
    'label' => __('List WordPress Content', domain: 'elementor-mcp'),
    'description' => __(
    ...
    'permission_callback' => static fn(): bool => \elementor_mcp_current_user_can_manage(),
    'meta' => wordpress_core_mcp_meta(readonly: true),
]);

register_core_ability('elementor-mcp/get-content', [
    'label' => __('Get WordPress Content', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/search-content', [
    'label' => __('Search Site Content', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/get-page-snapshot', [
    'label' => __('Get Page Snapshot', domain: 'elementor-mcp'),
    'description' => __(
        'Returns a compact normalized page digest: identity, template, content fingerprints, block outline, Elementor ownership, SEO candidates, and modification state.',
        domain: 'elementor-mcp',
    ),
    'category' => 'wordpress',
    'input_schema' => [
...
function wordpress_list_content(array $input): array|WP_Error
{
    ...
    if ($post_types === []) {
        return new WP_Error('elementor_mcp_no_valid_post_types', __(
...
function wordpress_get_content(array $input): array|WP_Error
{
    ...
    if (!$post instanceof WP_Post || !current_user_can('read_post', $post->ID)) {
        return new WP_Error('elementor_mcp_content_not_found', __(
