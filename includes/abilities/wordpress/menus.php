...
register_core_ability('elementor-mcp/create-menu', [
    'label' => __('Create Menu', domain: 'elementor-mcp'),
    'description' => __(
        'Creates an empty classic navigation menu and returns its ID. Add entries with elementor-mcp/upsert-menu-item and put it on the site with elementor-mcp/assign-menu-location.',
...
register_core_ability('elementor-mcp/update-menu', [
    'label' => __('Update Menu', domain: 'elementor-mcp'),
    'description' => __('Renames an existing classic navigation menu.', domain: 'elementor-mcp'),
    'category' => 'wordpress',
    'input_schema' => [
        'type' => 'object',
        'properties' => [
...
register_core_ability('elementor-mcp/delete-menu', [
    'label' => __('Delete Menu', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/list-menu-locations', [
    'label' => __('List Menu Locations', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/assign-menu-location', [
    'label' => __('Assign Menu Location', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/reorder-menu-items', [
    'label' => __('Reorder Menu Items', domain: 'elementor-mcp'),
    'description' => __(
...
function wordpress_assign_menu_location(array $input): array|WP_Error
{
    ...
    if (!array_key_exists($location, get_registered_nav_menus())) {
        return new WP_Error(
            ...
            sprintf(
                'The active theme does not register a navigation location named "%s". Call elementor-mcp/list-menu-locations for the available slugs.',
                $location,
            ),
            ['status' => 422],
        );
