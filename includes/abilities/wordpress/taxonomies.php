 ...
 * @var list<string>
 */
const ELEMENTOR_MCP_NON_AGENT_TAXONOMIES = [
    'nav_menu',
    'link_category',
    'wp_theme',
...
register_core_ability('elementor-mcp/list-taxonomies', [
    'label' => __('List Taxonomies', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/list-terms', [
    'label' => __('List Terms', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/get-term', [
    'label' => __('Get Term', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/create-term', [
    'label' => __('Create Term', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/update-term', [
    'label' => __('Update Term', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/delete-term', [
    'label' => __('Delete Term', domain: 'elementor-mcp'),
    'description' => __(
...
register_core_ability('elementor-mcp/assign-terms', [
    'label' => __('Assign Terms', domain: 'elementor-mcp'),
    'description' => __(
...
{
    if (in_array($taxonomy, ELEMENTOR_MCP_NON_AGENT_TAXONOMIES, strict: true)) {
        return new WP_Error(
