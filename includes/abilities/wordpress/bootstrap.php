 ...
 * ship in Elementor MCP Free and never call into Pro: Pro is for plugin-aware
 ...
 */
function elementor_mcp_register_wordpress_ability_category(): void
{
    ...
    wp_register_ability_category('wordpress', [
        'label' => __('WordPress', domain: 'elementor-mcp'),
        'description' => __(
 ...
 */
function elementor_mcp_load_wordpress_abilities(): void
{
    $dir = __DIR__ . '/';
    ...
    require_once $dir . 'search-images.php';
