...
namespace ElementorMCP\Troubleshoot\UI;
 ...
 * method chooser via window.elementorMcpTsSetMethod().
 */
...
{
    $prefix = 'elementor-mcp-ts-' . sanitize_html_class($context);
    $registry = \ElementorMCP\Troubleshoot\ClientIds\registry();
    // Each symptom applies to one method (or both); the picker hides the rest.
    $symptoms = [
        'registration' => [
            'method' => 'oauth',
            'label' => __('My AI client shows a registration or sign-in service error', domain: 'elementor-mcp'),
        ],
        'login-loop' => [
            'method' => 'oauth',
            'label' => __('The login page opens but authorizing loops or goes nowhere', domain: 'elementor-mcp'),
        ],
        'was-working' => [
            'method' => 'oauth',
            'label' => __('It worked before, now requests fail with 401', domain: 'elementor-mcp'),
        ],
        'no-tools' => [
            'method' => '',
            'label' => __('The client connects but shows no Elementor MCP tools', domain: 'elementor-mcp'),
        ],
        'password-401' => [
            'method' => 'password',
            'label' => __('The Application Password method fails with 401', domain: 'elementor-mcp'),
        ],
        'token-401' => [
            'method' => 'token',
            'label' => __('My access token is rejected with 401', domain: 'elementor-mcp'),
        ],
    ];
    ?>
    <div
        class="elementor-mcp-troubleshoot"
        id="<?php echo esc_attr($prefix); ?>"
        data-elementor-mcp-ts-method="<?php echo esc_attr($method); ?>"
    >
        <div class="elementor-mcp-ts-controls">
            <?php if ($with_method_picker): ?>
                <label class="elementor-mcp-ts-method-pick">
                    <span class="elementor-mcp-ts-method-label"><?php esc_html_e(
                        'How do you connect?',
                        domain: 'elementor-mcp',
                    ); ?></span>
                    <select data-elementor-mcp-ts="method-pick">
            ...
            <?php endif; ?>
            <button type="button" class="button button-primary" data-elementor-mcp-ts="run"><?php esc_html_e(
                'Run diagnostics',
                domain: 'elementor-mcp',
            ); ?></button>
        </div>

        <div class="elementor-mcp-ts-summary" data-elementor-mcp-ts="summary" hidden></div>
        <div class="elementor-mcp-ts-clean" data-elementor-mcp-ts="clean" hidden></div>
        <ul class="elementor-mcp-ts-report" data-elementor-mcp-ts="report" aria-live="polite"></ul>
        <div class="elementor-mcp-ts-copy-report" data-elementor-mcp-ts="copy-report" hidden></div>

        <div class="elementor-mcp-ts-symptoms" data-elementor-mcp-ts="symptoms" hidden>
            <p class="elementor-mcp-ts-symptoms-title"><?php esc_html_e(
                'What do you see in your AI client?',
                domain: 'elementor-mcp',
            ); ?></p>
            <select data-elementor-mcp-ts="symptom">
                <option value=""><?php esc_html_e('Pick the closest symptom…', domain: 'elementor-mcp'); ?></option>
            ...
            <div class="elementor-mcp-ts-branch" data-elementor-mcp-ts-branch="registration" hidden>
                <p><?php esc_html_e(
                ...
                <p class="elementor-mcp-ts-mint-controls">
                    <select data-elementor-mcp-ts="client">
                    ...
                    <button type="button" class="button" data-elementor-mcp-ts="mint"><?php esc_html_e(
                        'Generate Auth Client ID',
                        domain: 'elementor-mcp',
                    ); ?></button>
                </p>
                <div data-elementor-mcp-ts="mint-result" hidden>
                    <p class="elementor-mcp-ts-mint-row">
                        <code class="elementor-mcp-ts-mint-id" data-elementor-mcp-ts="mint-id"></code>
                        <button type="button" class="button" data-elementor-mcp-ts="mint-copy"><?php esc_html_e(
                            'Copy',
                            domain: 'elementor-mcp',
                        ); ?></button>
                    </p>
                    <p class="description" data-elementor-mcp-ts="mint-hint"></p>
                    <p class="description"><?php esc_html_e(
                        'This ID stays valid until it is used (or deleted from Connected Apps, where it is listed as manually created).',
                        domain: 'elementor-mcp',
                    ); ?></p>
                </div>
                <p class="description" data-elementor-mcp-ts="mint-error" hidden></p>
            </div>

            <div class="elementor-mcp-ts-branch" data-elementor-mcp-ts-branch="login-loop" hidden>
                <p><?php esc_html_e(
            ...
            <div class="elementor-mcp-ts-branch" data-elementor-mcp-ts-branch="was-working" hidden>
                <p><?php esc_html_e(
            ...
            <div class="elementor-mcp-ts-branch" data-elementor-mcp-ts-branch="no-tools" hidden>
                <p><?php esc_html_e(
            ...
            <div class="elementor-mcp-ts-branch" data-elementor-mcp-ts-branch="password-401" hidden>
                <p><?php esc_html_e(
...
function render_assets_once(): void
{
    ...
    $labels = [
        'ok' => __('OK', domain: 'elementor-mcp'),
        'warning' => __('Warning', domain: 'elementor-mcp'),
        'fail' => __('Problem', domain: 'elementor-mcp'),
        'skipped' => __('Skipped', domain: 'elementor-mcp'),
        'info' => __('Heads up', domain: 'elementor-mcp'),
        'allOk' => __('All checks passed', domain: 'elementor-mcp'),
        'clean' => __(
        ...
        'caveat' => __('Checks passed, with something to note', domain: 'elementor-mcp'),
        'error' => __('Could not run the checks. Reload the page and try again.', domain: 'elementor-mcp'),
        'copy' => __('Copy', domain: 'elementor-mcp'),
        'copied' => __('Copied!', domain: 'elementor-mcp'),
        'copyReport' => __('Copy report for support', domain: 'elementor-mcp'),
        'reportCopied' => __('Report copied', domain: 'elementor-mcp'),
        'openFix' => __('Open the fix below', domain: 'elementor-mcp'),
    ];
    ?>
    <?php // Styles for this screen live in includes/assets/admin.css (the elementor-mcp-ts-* section). ?>
    <script>
    (function () {
        var nonce = <?php echo wp_json_encode($rest_nonce); ?>;
        var runUrl = <?php echo wp_json_encode(rest_url('elementor-mcp/v1/troubleshoot/run-checks')); ?>;
        var mintUrl = <?php echo wp_json_encode(rest_url('elementor-mcp/v1/troubleshoot/client-id')); ?>;
        ...
        function renderSkeleton(list) {
            ...
            for (var i = 0; i < 3; i++) {
                ...
                li.className = 'elementor-mcp-ts-skeleton';
                list.appendChild(li);
            }
        }
        ...
        function renderSummary(summary, counts) {
            ...
            ['fail', 'warning', 'info'].filter(function (key) { return counts[key] > 0; }).forEach(function (key) {
                ...
                chip.className = 'elementor-mcp-ts-chip is-' + key;
        ...
        function buildRow(c, i) {
            ...
            var li = document.createElement('li');
            li.className = 'elementor-mcp-ts-row is-' + status;
            li.style.animationDelay = (i * 45) + 'ms';

            var dot = document.createElement('span');
            dot.className = 'elementor-mcp-ts-dot';
            dot.textContent = glyphs[status];
            dot.setAttribute('aria-label', labels[status] || status);
            li.appendChild(dot);

            var body = document.createElement('div');
            body.className = 'elementor-mcp-ts-row-body';
            var title = document.createElement('div');
            title.className = 'elementor-mcp-ts-row-title';
            title.textContent = c.label;
            body.appendChild(title);
            var msg = document.createElement('div');
            msg.className = 'elementor-mcp-ts-row-msg';
            msg.textContent = c.message;
            body.appendChild(msg);

            if (c.remedy) {
                var fix = document.createElement('div');
                fix.className = 'elementor-mcp-ts-remedy';
                ...
                if (c.action) {
                    ...
                    open.setAttribute('data-elementor-mcp-ts-open', c.action);
                ...
                if (c.copy) {
                    ...
                    copyWrap.className = 'elementor-mcp-ts-copy';
                    var copyText = document.createElement('pre');
                    copyText.className = 'elementor-mcp-ts-copy-text';
                    ...
                    copyBtn.setAttribute('data-elementor-mcp-ts', 'remedy-copy');
        ...
        function renderCopyReport(container, report) {
            ...
            btn.setAttribute('data-elementor-mcp-ts', 'report-copy');
        ...
        function renderReport(els, data) {
            ...
            els.clean.className = 'elementor-mcp-ts-clean';
            ...
            if (problems.length === 0) {
                ...
                els.clean.className = 'elementor-mcp-ts-clean is-caveat';
        ...
        function resetPanel(panel) {
            var report = panel.querySelector('[data-elementor-mcp-ts="report"]');
            var summary = panel.querySelector('[data-elementor-mcp-ts="summary"]');
            var clean = panel.querySelector('[data-elementor-mcp-ts="clean"]');
            var copyReport = panel.querySelector('[data-elementor-mcp-ts="copy-report"]');
            var symptoms = panel.querySelector('[data-elementor-mcp-ts="symptoms"]');
            var symptomSelect = panel.querySelector('[data-elementor-mcp-ts="symptom"]');
            if (report) { report.textContent = ''; }
            if (summary) { summary.hidden = true; summary.textContent = ''; }
            if (clean) { clean.hidden = true; clean.className = 'elementor-mcp-ts-clean'; }
            ...
            panel.querySelectorAll('[data-elementor-mcp-ts-branch]').forEach(function (b) { b.hidden = true; });
        }

        function applyMethod(panel) {
            var method = panel.getAttribute('data-elementor-mcp-ts-method') || '';
            var select = panel.querySelector('[data-elementor-mcp-ts="symptom"]');
            if (!select) { return; }
        ...
        window.elementorMcpTsSetMethod = function (method) {
            document.querySelectorAll('.elementor-mcp-troubleshoot').forEach(function (panel) {
                var known = method === 'oauth' || method === 'password' || method === 'token';
            panel.setAttribute('data-elementor-mcp-ts-method', known ? method : '');
                applyMethod(panel);
            });
        };

        document.querySelectorAll('.elementor-mcp-troubleshoot').forEach(applyMethod);

        document.addEventListener('click', function (e) {
            var target = e.target;
            if (!(target instanceof Element)) { return; }
            var panel = target.closest('.elementor-mcp-troubleshoot');
            if (!panel) { return; }

            var openSymptom = target.getAttribute('data-elementor-mcp-ts-open');
            if (openSymptom) {
                var symptomSelect = panel.querySelector('[data-elementor-mcp-ts="symptom"]');
                symptomSelect.value = openSymptom;
                symptomSelect.dispatchEvent(new Event('change', { bubbles: true }));
                var branch = panel.querySelector('[data-elementor-mcp-ts-branch="' + openSymptom + '"]');
                if (branch) { branch.scrollIntoView({ behavior: 'smooth', block: 'nearest' }); }
                return;
            }

            var action = target.getAttribute('data-elementor-mcp-ts');
            if (!action) { return; }

            if (action === 'run') {
                var els = {
                    report: panel.querySelector('[data-elementor-mcp-ts="report"]'),
                    summary: panel.querySelector('[data-elementor-mcp-ts="summary"]'),
                    clean: panel.querySelector('[data-elementor-mcp-ts="clean"]'),
                    copyReport: panel.querySelector('[data-elementor-mcp-ts="copy-report"]')
                };
                var method = panel.getAttribute('data-elementor-mcp-ts-method') || '';
                els.summary.hidden = true;
                els.clean.hidden = true;
                ...
                var methodPick = panel.querySelector('[data-elementor-mcp-ts="method-pick"]');
            ...
            if (action === 'mint') {
                var client = panel.querySelector('[data-elementor-mcp-ts="client"]').value;
                var out = panel.querySelector('[data-elementor-mcp-ts="mint-result"]');
                var err = panel.querySelector('[data-elementor-mcp-ts="mint-error"]');
                target.disabled = true;
                post(mintUrl, { client: client }).then(function (r) {
                    ...
                    err.hidden = true;
                    panel.querySelector('[data-elementor-mcp-ts="mint-id"]').textContent = r.json.client_id;
                    panel.querySelector('[data-elementor-mcp-ts="mint-hint"]').textContent = r.json.field_hint;
                    out.hidden = false;
                }).catch(function () {
                    target.disabled = false;
            ...
            if (action === 'remedy-copy') {
                var block = target.closest('.elementor-mcp-ts-copy').querySelector('.elementor-mcp-ts-copy-text');
                window.elementorMcpClipboardCopy(block.textContent).then(function () {
            ...
            if (action === 'report-copy') {
                var reportEl = panel.querySelector('[data-elementor-mcp-ts="copy-report"]');
                window.elementorMcpClipboardCopy(reportEl.getAttribute('data-report') || '').then(function () {
            ...
            if (action === 'mint-copy') {
                var id = panel.querySelector('[data-elementor-mcp-ts="mint-id"]').textContent;
                window.elementorMcpClipboardCopy(id).then(function () {
                    var orig = target.textContent;
                    target.textContent = labels.copied;
                    setTimeout(function () { target.textContent = orig; }, 1500);
                });
        ...
        document.addEventListener('change', function (e) {
            var target = e.target;
            if (!(target instanceof Element)) { return; }
            var tsAttr = target.getAttribute('data-elementor-mcp-ts');
            if (tsAttr === 'method-pick') {
                if (window.elementorMcpTsSetMethod) { window.elementorMcpTsSetMethod(target.value); }
                var mpPanel = target.closest('.elementor-mcp-troubleshoot');
                if (mpPanel) { resetPanel(mpPanel); }
                return;
            }
            if (tsAttr !== 'symptom') { return; }
            var panel = target.closest('.elementor-mcp-troubleshoot');
            panel.querySelectorAll('[data-elementor-mcp-ts-branch]').forEach(function (branch) {
                branch.hidden = branch.getAttribute('data-elementor-mcp-ts-branch') !== target.value;
            });
        });
    })();
    </script>
