...
{
    $connections = function_exists('elementor_mcp_get_connections') ? count(elementor_mcp_get_connections(limit: 200)) : 0;
    ...
    return [
        ...
        'pro' => function_exists('elementor_mcp_pro_is_active') ? elementor_mcp_pro_is_active() : defined('ELEMENTOR_MCP_PRO_VERSION'),
        'pro_version' => defined('ELEMENTOR_MCP_PRO_VERSION') ? ELEMENTOR_MCP_PRO_VERSION : null,
        'wp' => get_bloginfo('version'),
        'php' => PHP_VERSION,
        'locale' => get_locale(),
        'multisite' => is_multisite(),
        'profile' => function_exists('elementor_mcp_get_safety_profile') ? elementor_mcp_get_safety_profile() : null,
        'abilities_enabled' => function_exists('elementor_mcp_is_enabled') ? (bool) elementor_mcp_is_enabled() : false,
...
function send(string $event = 'ping'): void
{
    ...
    wp_remote_post(ENDPOINT, [
        ...
        'user-agent' => 'Elementor MCP/' . (defined('ELEMENTOR_MCP_VERSION') ? ELEMENTOR_MCP_VERSION : '0') . '; ' . home_url(),
    ]);
}
