...
namespace ElementorMCP\Telemetry;
...
const OPTION_ENABLED = 'elementor_mcp_telemetry_enabled';
const OPTION_INSTALL_ID = 'elementor_mcp_install_id';

const CRON_HOOK = 'elementor_mcp_telemetry_ping';

const ENDPOINT = 'https://elementormcp.com/api/elementor-mcp/telemetry';
 ...
 *
 * true is accepted alongside '1' because that is the test elementor_mcp_is_enabled()
...
/**
 * Add the toggle to the Elementor MCP settings screen.
 *
...
function register_setting(mixed $sections): mixed
{
    ...
    $sections[] = [
        'id' => 'elementor-mcp-telemetry',
        'title' => __('Anonymous usage reporting', domain: 'elementor-mcp'),
        'description' => __(
        ...
        'fields' => [
            [
                'type' => 'toggle',
                'name' => OPTION_ENABLED,
                'label' => __('Send anonymous usage data once a day', domain: 'elementor-mcp'),
                'help' => __(
                    'Sends this site\'s URL, the Elementor MCP, WordPress and PHP versions, your locale, whether Pro is active, your safety profile, and how many connections exist. It never sends usernames, email addresses, post content, or any record of what an agent did. Turning this off sends one final message asking us to delete what was collected.',
                    domain: 'elementor-mcp',
                ),
                'value' => enabled(),
